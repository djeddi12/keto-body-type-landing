...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-keto-navy text-white pt-16 pb-8">
      <div className="keto-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#who-its-for" className="text-gray-300 hover:text-white">Who It's For</a></li>
        ...
        <div className="mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <button 
            onClick={scrollToTop}
            className="bg-keto-teal/20 hover:bg-keto-teal/30 text-white p-3 rounded-full transition-colors"
          >
