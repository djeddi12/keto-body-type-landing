        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div>
                <span className="keto-highlight mb-3 inline-block">GET YOUR COPY TODAY</span>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="bg-keto-teal/10 rounded-full p-2 mr-4">
                    <Shield className="h-6 w-6 text-keto-teal" />
                  </div>
                  <div>
                    <h3 className="font-bold text-lg">60-Day Money Back Guarantee</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg">Instant Digital Access</h3>
                    <p className="text-gray-600">
                      Get instant access to the complete guide in PDF format that works on any device - start implementing today.
                    </p>
                  </div>
                </div>
              ...
              <div className="pt-4">
                ...
                <div className="text-center mt-4 text-sm text-gray-500 flex justify-center items-center space-x-3">
                  ...
                  <span>|</span>
                  <span>Processed by Digistore24.com</span>
                </div>
              </div>
            </div>
